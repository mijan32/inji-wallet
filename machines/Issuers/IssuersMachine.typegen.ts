...
"verifyCredential": "done.invoke.issuersMachine.verifyingCredential:invocation[0]";
        ...
        missingImplementations: {
          actions: "downloadIssuerWellknown" | "loadKeyPair" | "logDownloaded" | "resetCredentialOfferIssuer" | "resetError" | "resetLoadingReason" | "resetQrData" | "resetRequestConsentToTrustIssuer" | "resetRequestTxCode" | "resetSelectedCredentialType" | "resetVerificationErrorMessage" | "resetVerificationResult" | "sendBackupEvent" | "sendDownloadingFailedToVcMeta" | "sendErrorEndEvent" | "sendImpressionEvent" | "sendSuccessEndEvent" | "setAccessToken" | "setCNonce" | "setCredential" | "setCredentialOfferIssuer" | "setCredentialOfferIssuerWellknownResponse" | "setCredentialTypeListDownloadFailureError" | "setCredentialWrapper" | "setError" | "setIssuerDisplayDetails" | "setIssuers" | "setLoadingReasonAsDisplayIssuers" | "setLoadingReasonAsDownloadingCredentials" | "setLoadingReasonAsSettingUp" | "setMetadataInCredentialData" | "setNetworkOrTechnicalError" | "setOfferCredentialTypeContexts" | "setPrivateKey" | "setPublicKey" | "setQrData" | "setRequestConsentToTrustIssuer" | "setRequestTxCode" | "setSelectedCredentialType" | "setSelectedIssuerId" | "setSelectedIssuers" | "setSelectedKey" | "setSupportedCredentialTypes" | "setTxCode" | "setTxCodeDisplayDetails" | "setVCMetadata" | "setVerifiableCredential" | "setVerificationResult" | "storeKeyPair" | "storeVcMetaContext" | "storeVcsContext" | "storeVerifiableCredentialData" | "storeVerifiableCredentialMeta" | "updateIssuerFromWellknown" | "updateSelectedIssuerWellknownResponse" | "updateVerificationErrorMessage";
          delays: never;
          guards: "canSelectIssuerAgain" | "hasUserCancelledBiometric" | "isCredentialOfferFlow" | "isGenericError" | "isKeyTypeNotFound" | "isSignedIn" | "isVerificationPendingBecauseOfNetworkIssue" | "shouldFetchIssuersAgain";
          services: "constructProof" | "constructProofForTrustedIssuers" | "downloadCredential" | "downloadCredentialFromOffer" | "downloadIssuerWellknown" | "downloadIssuersList" | "generateKeyPair" | "getCredentialTypes" | "getKeyOrderList" | "getKeyPair" | "isUserSignedAlready" | "sendConsentGiven" | "sendConsentNotGiven" | "sendTxCode" | "updateCredential" | "verifyCredential";
        };
...
"logDownloaded": "done.invoke.issuersMachine.proccessingCredential:invocation[0]" | "done.invoke.issuersMachine.verifyingCredential:invocation[0]" | "error.platform.issuersMachine.verifyingCredential:invocation[0]";
"resetCredentialOfferIssuer": "error.platform.issuersMachine.credentialDownloadFromOffer.sendConsentGiven:invocation[0]" | "error.platform.issuersMachine.credentialDownloadFromOffer.sendTxCode:invocation[0]";
"resetError": "RESET_ERROR" | "TRY_AGAIN";
"resetLoadingReason": "CANCEL" | "RESET_ERROR" | "done.invoke.issuersMachine.displayIssuers:invocation[0]" | "error.platform.issuersMachine.credentialDownloadFromOffer.keyManagement.constructProof:invocation[0]" | "error.platform.issuersMachine.credentialDownloadFromOffer.keyManagement.getKeyPairFromKeystore:invocation[0]" | "error.platform.issuersMachine.credentialDownloadFromOffer.keyManagement.setSelectedKey:invocation[0]" | "error.platform.issuersMachine.credentialDownloadFromOffer.sendConsentGiven:invocation[0]" | "error.platform.issuersMachine.credentialDownloadFromOffer.sendTxCode:invocation[0]" | "error.platform.issuersMachine.credentialDownloadFromOffer:invocation[0]" | "error.platform.issuersMachine.downloadCredentials.constructProof:invocation[0]" | "error.platform.issuersMachine.downloadCredentials.keyManagement.getKeyPairFromKeystore:invocation[0]" | "error.platform.issuersMachine.downloadCredentials.keyManagement.setSelectedKey:invocation[0]" | "error.platform.issuersMachine.downloadCredentials:invocation[0]" | "error.platform.issuersMachine.downloadIssuerWellknown:invocation[0]" | "error.platform.issuersMachine.getCredentialTypes:invocation[0]" | "error.platform.issuersMachine.verifyingCredential:invocation[0]";
"resetQrData": "CANCEL" | "error.platform.issuersMachine.credentialDownloadFromOffer.sendConsentGiven:invocation[0]" | "error.platform.issuersMachine.credentialDownloadFromOffer.sendTxCode:invocation[0]";
"resetRequestConsentToTrustIssuer": "CANCEL" | "ON_CONSENT_GIVEN" | "error.platform.issuersMachine.credentialDownloadFromOffer.sendConsentGiven:invocation[0]";
...
"resetSelectedCredentialType": "CANCEL" | "error.platform.issuersMachine.credentialDownloadFromOffer.keyManagement.constructProof:invocation[0]" | "error.platform.issuersMachine.credentialDownloadFromOffer.keyManagement.getKeyPairFromKeystore:invocation[0]" | "error.platform.issuersMachine.credentialDownloadFromOffer.keyManagement.setSelectedKey:invocation[0]" | "error.platform.issuersMachine.credentialDownloadFromOffer:invocation[0]" | "error.platform.issuersMachine.downloadCredentials.constructProof:invocation[0]" | "error.platform.issuersMachine.downloadCredentials.keyManagement.getKeyPairFromKeystore:invocation[0]" | "error.platform.issuersMachine.downloadCredentials.keyManagement.setSelectedKey:invocation[0]" | "error.platform.issuersMachine.downloadCredentials:invocation[0]";
...
"sendDownloadingFailedToVcMeta": "error.platform.issuersMachine.credentialDownloadFromOffer.keyManagement.constructProof:invocation[0]" | "error.platform.issuersMachine.credentialDownloadFromOffer.keyManagement.getKeyPairFromKeystore:invocation[0]" | "error.platform.issuersMachine.credentialDownloadFromOffer.keyManagement.setSelectedKey:invocation[0]" | "error.platform.issuersMachine.credentialDownloadFromOffer:invocation[0]" | "error.platform.issuersMachine.downloadCredentials.constructProof:invocation[0]" | "error.platform.issuersMachine.downloadCredentials.keyManagement.getKeyPairFromKeystore:invocation[0]" | "error.platform.issuersMachine.downloadCredentials.keyManagement.setSelectedKey:invocation[0]" | "error.platform.issuersMachine.downloadCredentials:invocation[0]";
...
"sendSuccessEndEvent": "done.invoke.issuersMachine.proccessingCredential:invocation[0]" | "done.invoke.issuersMachine.verifyingCredential:invocation[0]";
...
"setLoadingReasonAsDownloadingCredentials": "ON_CONSENT_GIVEN" | "QR_CODE_SCANNED" | "SELECTED_CREDENTIAL_TYPE" | "TRY_AGAIN" | "done.invoke.issuersMachine.credentialDownloadFromOffer.keyManagement.generateKeyPair:invocation[0]" | "done.invoke.issuersMachine.downloadCredentials.keyManagement.generateKeyPair:invocation[0]";
"setLoadingReasonAsSettingUp": "SELECTED_ISSUER" | "TRY_AGAIN";
"setMetadataInCredentialData": "done.invoke.issuersMachine.proccessingCredential:invocation[0]" | "done.invoke.issuersMachine.verifyingCredential:invocation[0]" | "error.platform.issuersMachine.verifyingCredential:invocation[0]";
...
"setRequestConsentToTrustIssuer": "TRUST_ISSUER_CONSENT_REQUEST";
...
"setVCMetadata": "done.invoke.issuersMachine.proccessingCredential:invocation[0]" | "done.invoke.issuersMachine.verifyingCredential:invocation[0]" | "error.platform.issuersMachine.verifyingCredential:invocation[0]";
...
"setVerificationResult": "done.invoke.issuersMachine.proccessingCredential:invocation[0]" | "done.invoke.issuersMachine.verifyingCredential:invocation[0]";
...
"storeVcMetaContext": "done.invoke.issuersMachine.proccessingCredential:invocation[0]" | "done.invoke.issuersMachine.verifyingCredential:invocation[0]" | "error.platform.issuersMachine.verifyingCredential:invocation[0]";
"storeVcsContext": "done.invoke.issuersMachine.proccessingCredential:invocation[0]" | "done.invoke.issuersMachine.verifyingCredential:invocation[0]" | "error.platform.issuersMachine.verifyingCredential:invocation[0]";
"storeVerifiableCredentialData": "done.invoke.issuersMachine.proccessingCredential:invocation[0]" | "done.invoke.issuersMachine.verifyingCredential:invocation[0]" | "error.platform.issuersMachine.verifyingCredential:invocation[0]";
"storeVerifiableCredentialMeta": "done.invoke.issuersMachine.proccessingCredential:invocation[0]" | "done.invoke.issuersMachine.verifyingCredential:invocation[0]" | "error.platform.issuersMachine.verifyingCredential:invocation[0]";
...
"isGenericError": "error.platform.issuersMachine.credentialDownloadFromOffer:invocation[0]" | "error.platform.issuersMachine.downloadCredentials:invocation[0]";
...
"constructProofForTrustedIssuers": "TRY_AGAIN" | "done.invoke.issuersMachine.downloadCredentials.keyManagement.getKeyPairFromKeystore:invocation[0]";
...
"isUserSignedAlready": "done.invoke.issuersMachine.proccessingCredential:invocation[0]" | "done.invoke.issuersMachine.verifyingCredential:invocation[0]" | "error.platform.issuersMachine.verifyingCredential:invocation[0]";
"sendConsentGiven": "ON_CONSENT_GIVEN";
